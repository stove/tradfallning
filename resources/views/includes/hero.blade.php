...
<div  class="flex flex-col h-full w-auto justify-center items-center rounded-2xl bg-fixed bg-center bg-contain bg-no-repeat py-4 mt-3"
      style="background-color:#deebdd; background-image: linear-gradient(330deg, rgb(222, 235, 221,0.6), rgb(47, 55, 45,0.9)),url(/images/bg_forrest_sm.jpg)">
