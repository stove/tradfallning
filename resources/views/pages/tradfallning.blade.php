    ...
    <div class = "container mx-auto sm:px-4 my-5">
        <div class = "flex flex-wrap  p-6 pb-0 lg:pe-0 lg:pt-12 rounded-3 border shadow-lg">
            <div class = "lg:w-3/5 pr-4 pl-4 p-6 lg:p-12 lg:pt-4">
                <h1 class = "font-bold leading-tight text-gray-900 ">Trädfällning</h1>
                <p> Vi utför fällning av träd både på tomter och i skogsområden.
                ...
                <p> Prisuppgifter här gäller nertagning av trädet samt att alla grenar sågas av och trädet kapas i 60 cm
                    kubbar.
                ...
                <p>Här kan du läsa mer om var vi utför trädfällning i Skärgården :
                <ul>
